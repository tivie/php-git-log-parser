...
namespace Tivie\GitLogParser\Exception;

/**
 * Class Exception
 * A generic exception
 *
 * Note: This exception and all its children change the line and file in the backtrace log. If you wish to debug the
 * GitLogParser Library itself, use Exception::debugLibrary(true)
 *
 * @package Tivie\GitLogParser\Exception
 * @copyright 2014 Estevão Soares dos Santos
 */
class Exception extends \Exception
{
    ...
    /**
     * If you wish to debug the GitLogParser Library itself, you can set this flag to true. This will prevent
